...
var myTime = RunningWorkout(distance: 1600, time: 100, elevation: 22)
print("\(myTime.averageMileTime)")
/*:
...
struct Steps {
    var steps: Int{
        willSet{
            if steps == goal{
                print("Congratulations! You're achieved you daily goal! \(myRun.steps) steps!")
            }
        }
    }
    var goal: Int
...
var myRun = Steps(steps: 9999, goal: 10000)
myRun.takeStep()
myRun.takeStep()
