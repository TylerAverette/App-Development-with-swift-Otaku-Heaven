...
print("Pinpointed location: \(somePlace)")
/*:
...
let favoriteBook = Book(title: "One Piece", author: "Eiichiro Oda", pages: 2000, price: 1_000)
print("Your favorite book: \(favoriteBook)")
/*:
 ...
 */
var myHeight = Height(heightInCentimeters: 1653.1)
