 ...
 */
//falcon.weapon = "beam"
// No this does not work, because weapon is a child variable of fighter which is a child of Spaceship, and spaceship does not have access to variables specific to it's children classes. However, if weapon was declared in the base class, all subclasses would have access to the weapon variable.
/*:
