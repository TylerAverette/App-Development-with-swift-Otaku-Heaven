...
var calendar = ["January": 31, "February": 28, "March": 31]
/*:
 ...
 */
if let numDays = calendar.updateValue(31, forKey: "January"){
    print("January has \(numDays)")
}
...
var builds = ["Shapes":shapesArray , "Colors":colorsArray]
 ...
 */
if let lastElement = builds["Colors"]?.count{
   let myPrint = builds["Colors"]?[(lastElement-1)]
    print("\(myPrint)")
}
