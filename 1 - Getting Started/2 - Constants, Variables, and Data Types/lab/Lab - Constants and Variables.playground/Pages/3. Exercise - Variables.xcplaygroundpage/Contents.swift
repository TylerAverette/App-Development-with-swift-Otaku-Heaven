 ...
 */
//Yes, the above code will compile, because variables can be updated and changed as needed. On the other hand, constants can't be updated, so if schooling was a constant, the code would break.
