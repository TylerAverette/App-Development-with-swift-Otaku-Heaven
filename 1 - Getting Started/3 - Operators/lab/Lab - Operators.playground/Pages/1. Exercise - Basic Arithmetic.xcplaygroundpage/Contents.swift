...
print("The area of the she is \(area).")
/*:
...
print("The area of your shed split into two rooms is \(roomArea) for each half.")

/*:
 Create a `perimeter` constant whose value equals `width` plus `width` plus `height` plus `height`, then print out the result.
 */
let shedPerimeter = (2 * width) + (2 * height)

print ("The perimeter of your shed is \(shedPerimeter)")
/*:
