 ...
 */
let names: [String] = ["Shelly", "Nicole", "Chris", "John"]

let sortedCollection1 = names.sorted(by: forwards)

let sortedNames = names.sorted{a,b in a < b}
let sortedNames2 = names.sorted{a,b in return a < b}
let sortedNames4 = names.sorted{a,b in forwards(a,b)}
let sortedNames5 = names.sorted(by:{a,b in forwards(a,b)})

let sortedNames6 = names.sorted{ (a,b) in return a < b}
