...
//        Emoji(symbol: "😟", name: "Worried Face", description: "A face with a frown and raised eyebrows.", usage: "Worrying")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EditEmoji"{
            ...
            let addEditEmojiTableViewController = navController.topViewController as! AddEditEmojiViewControllerTableViewController
            addEditEmojiTableViewController.emoji = emoji
        }
    }
    
    @IBAction func unwindToEmojiViewTable(segue: UIStoryboardSegue){
        guard segue.identifier == "saveUnwind",
            let sourceViewController = segue.source as? AddEditEmojiViewControllerTableViewController,
...
//        cell.showsReorderControl = true
        ...
        // Emoji Dictionary part II steps
        // Step 1: Deque the cell
